...
# TEST
    ...
    if len(_green) + len(_yellow) > 2 or len(_possible) < 100: 
        newpossible = complete(_round, _green, _yellow, _black, _answer, _not, _attempt, _possible, possible)
    
    # This is what happens if 2 or more letters are g/y
    
    else:
        _attempt = explore(_round, _green, _yellow, _black, _answer, _not, _attempt, _possible, possible)
    
    return newpossible, _attempt
...
_possible, _attempt = new(_round, _green, _yellow, _black, _answer, _not, _attempt, _possible, possible0)
feedback(_round, _green, _yellow, _black, _answer, _not, _attempt, _possible, possible0)

possible1 = []
transferlist(_possible, possible1)
new(_round, _green, _yellow, _black, _answer, _not, _attempt, _possible, possible1)
feedback(_round, _green, _yellow, _black, _answer, _not, _attempt, _possible, possible)

possible2 = []
transferlist(_possible, possible2)
new(_round, _green, _yellow, _black, _answer, _not, _attempt, _possible, possible2)
feedback(_round, _green, _yellow, _black, _answer, _not, _attempt, _possible, possible)

possible3 = []
transferlist(_possible, possible3)
new(_round, _green, _yellow, _black, _answer, _not, _attempt, _possible, possible2)
feedback(_round, _green, _yellow, _black, _answer, _not, _attempt, _possible, possible2)

possible4 = []
transferlist(_possible, possible4)
new(_round, _green, _yellow, _black, _answer, _not, _attempt, _possible, possible4)
feedback(_round, _green, _yellow, _black, _answer, _not, _attempt, _possible, possible4)
