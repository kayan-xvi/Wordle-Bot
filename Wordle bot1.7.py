...
_wordlist.remove('aeros')
_wordlist.remove('soare')
_wordlist.remove('aesir')
possible = _words.split('\n')
possible.remove('aeros')
possible.remove('soare')
possible.remove('aesir')
_possible = _words.split('\n')
_possible.remove('aeros')
_possible.remove('soare')
_possible.remove('aesir')
